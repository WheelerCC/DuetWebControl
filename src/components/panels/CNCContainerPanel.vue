  ...
  <div>
    <v-row align="stretch" dense>
      ...
      <v-col cols="12" lg="4" md="4" order="4" order-md="2" sm="12">
        <cnc-axes-position machine-position class="fill-height" />
      </v-col>
      ...
      <v-col cols="12" order="7">
        <cnc-axes-position :machine-position="false" class="fill-height" />
      </v-col>
    </v-row>
  </div>
</template>
...
export default Vue.extend({
  computed: {
    ...
    mainboard(): Board | undefined {
      return useMachinesModelStore().boards.find((board) => !board.canAddress)
    },
    ...
    probesPresent() {
      return useMachinesModelStore().sensors.probes.some(
        (probe) => probe && probe.type !== ProbeType.none,
      )
    },
    probes(): Array<Probe | null> {
      return useMachinesModelStore().sensors.probes
    },
    ...
    analogSensors(): Array<AnalogSensor> {
      return useMachinesModelStore().sensors.analog.filter(
