  ...
  <v-card>
    ...
    >
        ...
        >
          ...
          <v-col>
            ...
            >
              ...
              >
                <span
                  class="axis-span font-weight-bold"
      ...
      <template v-if="isFinite(model.move.currentMove.requestedSpeed) || isFinite(model.move.currentMove.topSpeed)">
        <v-divider
          v-if="visibleAxes.length + model.move.extruders.length > 0"
          class="my-2"
        />
      ...
      <template v-if="sensorsPresent">
        <v-divider
          v-if="(model.move.axes.length + model.move.extruders.length > 0) || isFinite(model.move.currentMove.requestedSpeed) || isFinite(model.move.currentMove.topSpeed)"
          class="my-2"
        />
