    ...
    <v-card-text>
      <v-row :dense="$vuetify.breakpoint.mobile">
        <template v-if="isRestConnector">
          <v-col cols="6">
            <v-text-field
              ...
              step="1"
              min="0"
              :label="$t('panel.settingsCommunication.pingInterval', ['ms'])"
              hide-details
            />
          </v-col>
          <v-col cols="6">
            <v-text-field
              ...
              step="1"
              min="0"
              :label="$t('panel.settingsCommunication.updateDelay', ['ms'])"
              hide-details
            />
          </v-col>
        </template>
        <template v-else-if="isPollConnector">
          <v-col cols="6">
            <v-text-field
              v-model.number="ajaxRetries"
              type="number"
              step="1"
              min="0"
              :label="$t('panel.settingsCommunication.ajaxRetries')"
              hide-details
            />
          </v-col>
          <v-col cols="6">
            <v-text-field
              ...
              step="1"
              min="0"
              :label="$t('panel.settingsCommunication.retryDelay')"
              hide-details
            />
          </v-col>
          <v-col cols="6">
            <v-text-field
              ...
              step="1"
              min="0"
              :label="$t('panel.settingsCommunication.updateInterval', ['ms'])"
              hide-details
            />
          </v-col>
          <v-col cols="6">
            <v-text-field
              v-model.number="fileTransferRetryThreshold"
              type="number"
              step="1"
              min="1"
          ...
          <v-col cols="12">
            <v-switch
              v-model="crcUploads"
              :label="$t('panel.settingsCommunication.crcUploads')"
              hide-details
              class="mt-0"
            />
          </v-col>
          <v-col cols="12">
            <v-switch
              v-model="ignoreFileTimestamps"
              :label="$t('panel.settingsGeneral.ignoreFileTimestamps')"
              class="mt-0"
              hide-details
            />
          </v-col>
