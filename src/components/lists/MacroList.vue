<template>
  <v-card>
    ...
    <v-card-text v-show="loading || filelist.length || !isRootDirectory" class="pa-0">
      <v-progress-linear v-show="loading" :indeterminate="true" class="my-0" />
...
export default defineComponent({
  ...
  computed: {
    ...
    isRootDirectory(): boolean {
      return Path.equals(this.directory, this.macrosDirectory)
    },
  },
  watch: {
