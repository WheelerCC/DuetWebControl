        ...
        <v-tabs-items v-model="tab">
          ...
          <v-tab-item value="analysis">
            <div class="d-flex flex-column">
              ...
              />
              <v-alert
                :value="files.length === 0 && !filesError"
                type="info"
                class="mb-0"
              >
                No Motion Profiles found. Record a new Motion Profile or <a
                  href="javascript:void(0)"
                  class="white--text text-decoration-underline"
                  @click="refresh"
                >refresh</a> the file list
              </v-alert>
              <v-alert
                :value="filesError"
                type="error"
              ...
              >
                ...
                >
                  ...
                  <v-card
                    outlined
                    class="d-block fill-height pa-2"
                  >
                    <input-shaping-chart
                      can-show-samples
                      :sample-start-index.sync="sampleStartIndex"
            ...
            >
              ...
              <v-card>
                ...
                <v-simple-table v-show="numCustomCoefficients > 0">
                  ...
                  <tbody>
                    <tr
                      v-for="(_, index) in customAmplitudes"
                      :key="index"
                    >
