...
const VLinePlugin = {
  ...
  renderVerticalLine(chartInstance, pointIndex) {
    ...
    context.beginPath()
    context.lineWidth =
      (chartInstance.options.plugins.vline && chartInstance.options.plugins.vline.lineWidth) || 1
    context.strokeStyle =
      (chartInstance.options.plugins.vline && chartInstance.options.plugins.vline.lineColor) ||
      '#ff0000'
