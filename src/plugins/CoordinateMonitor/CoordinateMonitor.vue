										...
										>
											...
											<td>
												...
												<div class="pa-4 d-flex align-center">
													<v-spacer></v-spacer>
													<v-btn @click="selectWorkplaceOffset(index)" block class="">
											...
											>
												<div class="pa-4 d-flex align-center">
													...
													<v-btn @click="setWorkplaceAxisZero([axis])" class="ml-10">
														{{ 'Set ' + [axis.letter] }}
													</v-btn>
													
													<v-btn @click="resetWorkplaceAxisZero([axis])" class="ml-1">
														{{ 'Reset' }}
													</v-btn>
													<v-spacer></v-spacer>
												</div>
											...
											<td>
												<v-btn @click="setWorkplaceAxisZero(visibleAxes)" block class="move-btn">
													{{ 'Set XYZ' }}
												</v-btn>
											</td>
										</tr>
